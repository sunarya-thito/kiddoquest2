                              ...
                              return ListenableBuilder(
                                ...
                                builder: (context, child) {
                                  ...
                                  for (var face in faces.value) {
                                    ...
                                    double heightAdjustment = faceHeight * 0.8;
                              ...
                              if (faces.value.length >= gameMinPlayers) {
                                ...
                                for (var face in faces.value) {
                                  ...
                                  var candidate = Candidate(
                                      session.capture(
                                          relativeRect: face.reference
                                              .references.first.boundingBox,
                                          expand: const Rect.fromLTWH(
                                              50, 50, 50, 50)),
                                      face,
                                  ...
                                  for (int i = 0; i < 1; i++) {
                                    ...
                                    for (int i = 0;
                                        ...
                                        i++) {
                                      if (candidate.canAcceptGender(
                                              characterPool[i].gender) &&
